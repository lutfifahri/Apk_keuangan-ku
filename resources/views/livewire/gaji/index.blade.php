            ...
            <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
                ...
                <tbody>
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="py-2 px-4 border-b">Bulanan</td>
                        <td class="py-2 px-4 border-b">10000</td>
                        <td class="py-2 px-4 border-b">Gaji saya di perusahaan</td>
                        <td class="py-2 px-4 border-b">
                            <a href="#" class="btn btn-sm btn-warning"><i class="fas fa-pencil text-lg"></i></a> |
